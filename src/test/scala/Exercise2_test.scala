...
class Exercise2_test extends funsuite.AnyFunSuite with BeforeAndAfter with ScalaFutures {
  ...
  test("Coffees table update works") {
    ...
    val sale_volume = Random
    val fix_sale_volme = sale_volume.nextInt(100)
